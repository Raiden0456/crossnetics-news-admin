  ...
  return (
    <div className='p-4 flex justify-between w-full gap-6'>
      <div className='flex flex-col gap-5'>
        <div className='flex flex-col items-center justify-center w-[301px] h-[145px] p-4 border-2 border-dashed border-ctp-pink rounded text-ctp-subtext1'>
          <input
            type='file'
        ...
        <div>
          <p className='text-ctp-subtext1 pb-4'>Images Copyright</p>
